...
const JobCard = ({ job }) => {
    const { title, location, jobType, category, description, company, requirements, status, company_logo } = job;

    return (
        <div className="group border bg-[#f2f6ff] hover:bg-white hover:shadow-xl hover:border-blue-500 rounded-xl px-6 py-8 duration-300 transition-transform hover:-translate-y-0.5">
